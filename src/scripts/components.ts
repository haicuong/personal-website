  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <nav class="flex gap-2 justify-center items-center">
        <a href="/"
          class="p-3 transition-colors rounded-lg bg-gray-300 dark:bg-[#454545] md:bg-transparent md:dark:bg-transparent active:bg-gray-400 dark:active:bg-[#565656] hover:bg-gray-300 dark:hover:bg-[#454545]"
        >
          Home
        </a>
        <a href="/projects/"
          class="p-3 transition-colors rounded-lg bg-gray-300 dark:bg-[#454545] md:bg-transparent md:dark:bg-transparent active:bg-gray-500 md:active:bg-gray-400 md:dark:active:bg-[#565656] hover:bg-gray-300 dark:hover:bg-[#454545]"
        >
          Projects
        </a>
        <a href="/blog/"
